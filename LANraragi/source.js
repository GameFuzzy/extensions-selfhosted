...
},{"./APIWrapper":2,"./base":6,"./models":28}],8:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Chapter":8,"./ChapterDetails":9,"./Constants":10,"./HomeSection":11,"./Languages":12,"./Manga":13,"./MangaTile":14,"./MangaUpdate":15,"./OAuth":16,"./PagedResults":17,"./RequestHeaders":18,"./RequestManager":19,"./RequestObject":20,"./ResponseObject":21,"./SearchRequest":22,"./SourceInfo":23,"./SourceTag":24,"./TagSection":25,"./TrackObject":26,"./UserForm":27}],29:[function(require,module,exports){
(function (Buffer){(function (){
"use strict";
...
class LANraragi extends paperback_extensions_common_1.Source {
    constructor() {
        super(...arguments);
        this.baseUrl = LANRARAGI_DOMAIN;
    ...
    getViewMoreItems(homepageSectionId, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const json = typeof response.data === "string" ? JSON.parse(response.data) : response.data;
            let items = this.parser.parseArchiveList(json.data, this);
...
},{"./Parser":31,"buffer":3,"paperback-extensions-common":7}],30:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
exports.reverseLangCode = {
    ...
    'BENGALI': paperback_extensions_common_1.LanguageCode.BENGALI,
    'BULGARIAN': paperback_extensions_common_1.LanguageCode.BULGARIAN,
    'BRAZILIAN': paperback_extensions_common_1.LanguageCode.BRAZILIAN,
    'CHINEESE': paperback_extensions_common_1.LanguageCode.CHINEESE,
    'CZECH': paperback_extensions_common_1.LanguageCode.CZECH,
    'GERMAN': paperback_extensions_common_1.LanguageCode.GERMAN,
    'DANISH': paperback_extensions_common_1.LanguageCode.DANISH,
    'ENGLISH': paperback_extensions_common_1.LanguageCode.ENGLISH,
    'SPANISH': paperback_extensions_common_1.LanguageCode.SPANISH,
    'FINNISH': paperback_extensions_common_1.LanguageCode.FINNISH,
    'FRENCH': paperback_extensions_common_1.LanguageCode.FRENCH,
    'GREEK': paperback_extensions_common_1.LanguageCode.GREEK,
    'CHINEESE_HONGKONG': paperback_extensions_common_1.LanguageCode.CHINEESE_HONGKONG,
    'HUNGARIAN': paperback_extensions_common_1.LanguageCode.HUNGARIAN,
    'INDONESIAN': paperback_extensions_common_1.LanguageCode.INDONESIAN,
    'ISRELI': paperback_extensions_common_1.LanguageCode.ISRELI,
    'INDIAN': paperback_extensions_common_1.LanguageCode.INDIAN,
    'IRAN': paperback_extensions_common_1.LanguageCode.IRAN,
    'ITALIAN': paperback_extensions_common_1.LanguageCode.ITALIAN,
    'JAPANESE': paperback_extensions_common_1.LanguageCode.JAPANESE,
    'KOREAN': paperback_extensions_common_1.LanguageCode.KOREAN,
    'LITHUANIAN': paperback_extensions_common_1.LanguageCode.LITHUANIAN,
    'MONGOLIAN': paperback_extensions_common_1.LanguageCode.MONGOLIAN,
    'MEXIAN': paperback_extensions_common_1.LanguageCode.MEXIAN,
    'MALAY': paperback_extensions_common_1.LanguageCode.MALAY,
    'DUTCH': paperback_extensions_common_1.LanguageCode.DUTCH,
    'NORWEGIAN': paperback_extensions_common_1.LanguageCode.NORWEGIAN,
    'PHILIPPINE': paperback_extensions_common_1.LanguageCode.PHILIPPINE,
    'POLISH': paperback_extensions_common_1.LanguageCode.POLISH,
    'PORTUGUESE': paperback_extensions_common_1.LanguageCode.PORTUGUESE,
    'ROMANIAN': paperback_extensions_common_1.LanguageCode.ROMANIAN,
    'RUSSIAN': paperback_extensions_common_1.LanguageCode.RUSSIAN,
    'SANSKRIT': paperback_extensions_common_1.LanguageCode.SANSKRIT,
    'SAMI': paperback_extensions_common_1.LanguageCode.SAMI,
    'THAI': paperback_extensions_common_1.LanguageCode.THAI,
    'TURKISH': paperback_extensions_common_1.LanguageCode.TURKISH,
    'UKRAINIAN': paperback_extensions_common_1.LanguageCode.UKRAINIAN,
    'VIETNAMESE': paperback_extensions_common_1.LanguageCode.VIETNAMESE
};

},{"paperback-extensions-common":7}],31:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class Parser {
    parseMangaDetails(json, mangaId, source) {
        var _a, _b, _c, _d;
    ...
    parseChapterDetails(json, mangaId, chapterId, source) {
        return createChapterDetails({
            id: chapterId,
            mangaId: mangaId,
            pages: json.pages.map((x) => `${source.baseUrl}${x.replace('.', '')}`),
            longStrip: false
        });
    }
    parseArchiveList(json, source) {
        var _a;
        let collectedTags = [];
        let results = [];
...
},{"./Languages":30,"paperback-extensions-common":7}]},{},[29])(29)
});
