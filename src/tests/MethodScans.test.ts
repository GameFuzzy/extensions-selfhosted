...
import { MethodScans } from '../MethodScans/MethodScans'
import { APIWrapper } from "paperback-extensions-common";

describe('MethodScans Tests', function () {


    var wrapper: APIWrapper = new APIWrapper();
    var source: Genkan = new MethodScans(cheerio);
     ...
     */
    var mangaId = "775872-peerless-dad";
