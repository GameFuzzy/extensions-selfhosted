...
import { EdelgardeScans } from '../EdelgardeScans/EdelgardeScans'
import { APIWrapper } from "paperback-extensions-common";

describe('EdelgardeScans Tests', function () {


    var wrapper: APIWrapper = new APIWrapper();
    var source: Genkan = new EdelgardeScans(cheerio);
