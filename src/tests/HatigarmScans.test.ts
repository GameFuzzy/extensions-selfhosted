...
import { HatigarmScans } from '../HatigarmScans/HatigarmScans'
import { APIWrapper } from "paperback-extensions-common";

describe('HatigarmScans Tests', function () {


    var wrapper: APIWrapper = new APIWrapper();
    var source: Genkan = new HatigarmScans(cheerio);
     ...
     */
    var mangaId = "574092-tales-of-demons-and-gods";
